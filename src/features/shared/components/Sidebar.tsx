...
import { Home, User, MessageSquare, Bell, LogOut, Settings } from 'lucide-react'
        ...
        <ul className="space-y-2 font-medium mt-4">
          {menuItems.map((item) => (
            <li key={item.path}>
              ...
              >
                <item.icon className={cn('w-5 h-5', location.pathname === item.path ? 'text-white' : 'text-gray-500 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white')} />
