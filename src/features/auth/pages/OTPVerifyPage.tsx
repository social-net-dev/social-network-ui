                ...
                <div className="w-full max-w-md space-y-8 rounded-lg bg-white p-8 shadow-lg">
                    <div className="text-center">
                        ...
                        <p className="mt-2 text-gray-600">
                            Trang nhập mã OTP chỉ dùng sau khi bạn đăng ký thành công. Nếu bạn vừa đăng ký, hãy kiểm tra email và thử quay lại bước
                            đăng ký rồi hoàn tất để được chuyển đến trang nhập mã.
                        </p>
