            ...
            {(() => {
              ...
              return (
                <div className="relative">
                  <Avatar user={userForAvatar} size="md" className="ring-2 ring-transparent hover:ring-primary/20 transition-all-300" />
                </div>
              );
            })()}
              ...
              >
                {blobUrls.map((blobUrl, index) => (
                  <img
                    ...
                    className={`rounded-xl hover:scale-[1.01] transition-transform duration-300 ${index === 0 && blobUrls.length > 1 ? "row-span-2" : ""} object-cover h-56`}
                  />
                ))}
              </div>
            ) : null}
